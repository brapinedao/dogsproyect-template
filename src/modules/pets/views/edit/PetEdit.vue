...
import usePetEdit from './PetEdit'

const { name, breed, dateOfBirth, loading, fetching, errorMessage, onSubmit, goBack } = usePetEdit()
</script>
  ...
  <q-page class="q-pa-lg pawcontrol-bg">
    ...
    <div class="row items-center q-mb-lg">
      ...
      <div class="row items-center no-wrap">
        ...
        <span class="text-h6 text-weight-bold" style="color: #1b0f42">Editar Mascota</span>
      </div>
    </div>

    <!-- Form card -->
    <q-card flat class="form-card q-pa-lg" style="max-width: 560px">
      <div v-if="fetching" class="column flex-center q-pa-xl">
      ...
      <q-form v-else @submit.prevent="onSubmit" class="q-gutter-md">
        ...
        <div>
          ...
          <input v-model="dateOfBirth" type="date" class="date-input" required />
        </div>
        ...
        <div class="row q-gutter-sm q-mt-sm">
          ...
          <BaseButton label="Guardar cambios" type="submit" :loading="loading" />
        </div>
      </q-form>
    </q-card>
  </q-page>
